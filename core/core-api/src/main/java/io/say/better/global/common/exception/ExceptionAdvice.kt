...
class ExceptionAdvice : ResponseEntityExceptionHandler() {
    ...
    public override fun handleMethodArgumentNotValid(
            ...
            @Nullable headers: HttpHeaders,
            @Nullable status: HttpStatusCode,
            @Nullable request: WebRequest
    ): ResponseEntity<Any> {
    ...
    fun exception(
        ...
        ExceptionAdvice.log.error("Exception 발생", exception)
    ...
    private fun handleExceptionInternal(
        ...
        val body: ResponseDto<Any?> = ResponseDto.Companion.onFailure<Any?>(reason.getCode(), reason.getMessage(), null)
    ...
    private fun handleExceptionInternalFalse(
        ...
        val body: ResponseDto<Any?> = ResponseDto.Companion.onFailure<Any?>(
