...
open class SolutionRepositoryTest @Autowired constructor(
    ...
    @BeforeEach
    fun setUp() {
        educator = educatorWriteRepository.save(
        ...
        learner = learnerWriteRepository.save(
        ...
        request = SolutionRequest.CreateSolution(
    ...
    inner class SaveSolutionTest {
        ...
        fun compareDifferentTest() {
            ...
            val otherRequest = SolutionRequest.CreateSolution(
                learnerEmail = learner.email,
                nowState = ProgressState.READY,
                educationGoal = "testEducationGoal",
                description = "testDescription",
